...
SaferStringView ssv2(std::string("Temporary"));

// From string literal (stores view)
SaferStringView ssv3("String Literal");

// From function returning string (takes ownership)
SaferStringView ssv4(std::to_string(42));
```
...
SaferStringView ssv(std::string("Safe String"));
...
std::string_view sv = std::string("temporary");  // sv now points to destroyed string!
...
SaferStringView ssv(std::string("temporary"));  // Owns the string
